...
public class AdminSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher //
                = this.getServletContext().getRequestDispatcher("/adminSearch.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // And redirect to userInfo page.
        	...
        	request.setAttribute("searchResult", user);//send search result to result page by request attribute
        		...
        		//tran data to jsp
        	//getServletConfig().getServletContext().getRequestDispatcher("/adminSearchResult.jsp").forward(request, response);
            //response.sendRedirect(request.getContextPath() + "/search.jsp");
        	RequestDispatcher dispatcher //
            = this.getServletContext().getRequestDispatcher("/adminSearchResult.jsp");
